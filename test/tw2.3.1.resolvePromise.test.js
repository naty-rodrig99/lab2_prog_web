...
const X= TEST_PREFIX;
const resolvePromise= (await getModule(`/src/${X}resolvePromise.js`))?.resolvePromise;
...
describe('TW2.3.1 resolvePromise [test](/tw2.3.1.html)', function tw2_3_1() {
  this.timeout(200000);

  before(function tw2_3_1_before() {
    if (!resolvePromise) this.skip();
  });

    it('resolvePromise sets data after the promise resolves', async function tw2_3_1_2() {
        let promiseState = {};
    ...
    it('resolvePromise sets error after the promise rejects', async function tw2_3_1_3() {
        let promiseState = {};
    ...
    it('resolvePromise checks for null promise', async function tw2_3_1_1() {
        let promiseState = {};
  ...
  it('resolvePromise check for race condition', async function tw2_3_1_4() {
    const promiseState = {};
