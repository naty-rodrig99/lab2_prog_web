...
describe("TW2.1.1 API config", function tw2_1_1() {
  ...
  it("apiConfig exports BASE_URL and API_KEY", function tw2_1_1_1() {
  ...
  it("Check BASE_URL is correct", function tw2_1_1_2() {
    expect(
      apiConfig.BASE_URL,
  ...
  it("Check length of API_KEY", function tw2_1_1_3() {
    expect(
      apiConfig.API_KEY,
