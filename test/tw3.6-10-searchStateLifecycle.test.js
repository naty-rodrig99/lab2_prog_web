...
const SearchFormView=(await getModule(`/src/views/${X}searchFormView.vue`))?.SearchFormView ||
    (await getModule(`/src/views/${X}searchFormView.jsx`))?.SearchFormView;
const SearchResultsView=(await getModule(`/src/views/${X}searchResultsView.vue`))?.SearchResultsView ||
    (await getModule(`/src/views/${X}searchResultsView.jsx`))?.SearchResultsView;
