...
render(
    <div>This page tests TW1.3 Basic Rendering in a SummaryView {getType(SummaryView)} for 3 people. We also use this page later to test TW1.3 Array Rendering, as it passes the ingredients prop.
      <hr/>
