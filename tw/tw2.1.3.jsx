...
if(getMenuDetails){
    ...
    const preamble= <div><p> This is the TW2.1.3 getMenuDetails test. It reads 3 dishes and, when they arrive, it saves them into the model</p>
                      <p>Check (and change in tw/tw2.1.3.jsx) the source code for other interesting dish IDs</p>
