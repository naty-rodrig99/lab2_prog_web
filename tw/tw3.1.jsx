...
const Sidebar=(await getModule(`/src/vuejs/${X}sidebarPresenter.jsx`))?.Sidebar ;
const Summary=(await getModule(`/src/vuejs/${X}summaryPresenter.jsx`))?.Summary ;
const Search=(await getModule(`/src/vuejs/${X}searchPresenter.jsx`))?.Search ;
const Details=(await getModule(`/src/vuejs/${X}detailsPresenter.jsx`))?.Details ;
...
const preamble= <div>
                  ...
                  <ul>
                    ...
                    <li>call notifyObservers from setNumberOfGuests, addToMenu, removeFromMenu, setCurrentDishId!</li>
