...
render(<div>
         This is the final TW1 test, it displays the full App. 
         ...
         <p>The Model is exported into the <code>myModel</code> global, so you can change the Model from the Console and see the changes in the UI. Test this at the Console: <code>myModel.setNumberOfGuests(3)
</code></p>
       </div>,
