...
let proxyModel;
const preamble=<div><p> This is the TW2.3.3 setCurrentDishId test</p>
                 ...
                 <p>You can edit tw/tw2.3.3.js to see other dish data in the promise state</p>
                 <hr/></div>;
...
setTimeout(function firstlyACB(){rootModel.setCurrentDishId(BB);}, 2000);

setTimeout(function laterACB(){rootModel.setCurrentDishId(AA);}, 6000);
