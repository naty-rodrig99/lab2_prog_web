...
if(searchDishes){
    ...
    const preamble= <div><p> This is the TW2.1.2 searchDishes test. It performs a search for pizza as main course.</p>
                      <p>You can change tw/tw2.1.2.jsx to perform other searches</p>
