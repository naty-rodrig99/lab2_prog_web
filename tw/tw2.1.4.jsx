...
const Sidebar=(await getModule(`/src/${Y}js/${X}sidebarPresenter.jsx`))?.Sidebar ;
const Summary=(await getModule(`/src/${Y}js/${X}summaryPresenter.jsx`))?.Summary ;
...
if(getDishDetails){
    ...
    const preamble= <div><p> This is the TW2.1.4 getDishDetails test. It reads 3 dishes as 3 promises (see Promise.all) and, when all arrive, it saves them into the model</p>
                      <p>Check (and change in tw/tw2.1.4.jsx) the source code for other interesting dish IDs</p>
